# Contributing to MethorZ HTTP Cache Middleware
...
1. Check the [existing issues](https://github.com/methorz/http-cache-middleware/issues) to avoid duplicates
...
Example test:
```php
public function testGeneratesETagForResponse(): void
{
    // Arrange
...
Good examples:
```
Add stale-while-revalidate directive support
Fix weak ETag comparison logic
Update README with CDN configuration examples (#42)
```
...
```
src/
├── Directive/      # Cache-Control directive builder
├── Generator/      # ETag generation
├── Integration/    # Framework integrations (Mezzio)
└── Middleware/     # PSR-15 caching middleware
...
- **Issues**: [GitHub Issues](https://github.com/methorz/http-cache-middleware/issues)
- **Discussions**: [GitHub Discussions](https://github.com/methorz/http-cache-middleware/discussions)
